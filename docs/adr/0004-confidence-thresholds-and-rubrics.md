...
corroboration for derived `origin_id` values only (unknown independence collapses to one origin),
and is capped deterministically by lifecycle state, staleness,
